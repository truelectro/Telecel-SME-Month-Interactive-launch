...
const EVENT_CONFIG = {
  ...
  DECAY_RATE_PER_SEC: parseFloat(process.env.DECAY_RATE_PER_SEC || '4.8'),       // Razor's Edge maximum decay
  SHAKE_VOLTAGE_BASE: parseFloat(process.env.SHAKE_VOLTAGE_BASE || '0.38'),     // Razor's Edge base per-shake power
